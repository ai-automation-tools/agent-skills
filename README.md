...
The rule underneath all of it: every number traces to a source or carries an `[assum]` tag, because the dominant failure of an LLM doing business analysis is inventing a plausible market size that gets cited downstream until the fabrication is load-bearing. Output is a folder of linked markdown in the [`repo-docs-builder`](./Skills/Documentation/repo-docs-builder/SKILL.md) house style — verdict on the front page, an index in every folder, humanized prose.

| Part | Link |
|:---|:---|
| 📄 **Skill** | [`SKILL.md`](./Skills/Business/business-plan-builder/SKILL.md) |
| 📚 **References** | [`analysis-passes.md`](./Skills/Business/business-plan-builder/references/analysis-passes.md) — the eight passes · [`evidence-rules.md`](./Skills/Business/business-plan-builder/references/evidence-rules.md) — tags, A–D grading, the research line · [`output-templates.md`](./Skills/Business/business-plan-builder/references/output-templates.md) — every document skeleton + the humanizer pass |
| 🗂️ **Skill-Data** | [`Resources/Skill-Data/Business/business-plan-builder/`](./Resources/Skill-Data/Business/business-plan-builder/README.md) |
| 📐 **Examples** | [Target output tree](./Resources/Skill-Data/Business/business-plan-builder/Examples/target-output-tree.md) · [worked root README](./Resources/Skill-Data/Business/business-plan-builder/Examples/example-root-README.md) |
...
| Part | Link |
|:---|:---|
| 📄 **Skill** | [`SKILL.md`](./Skills/Automation/html-email-templates/SKILL.md) |
| 🗂️ **Skill-Data** | [`Resources/Skill-Data/Automation/html-email-templates/`](./Resources/Skill-Data/Automation/html-email-templates/README.md) |
| 📐 **Examples** | [`Examples/`](./Resources/Skill-Data/Automation/html-email-templates/Examples/README.md) — a real, live-verified Template C email body + the notes from checking the skill against it |
...
| Part | Link |
|:---|:---|
| 📄 **Skill** | [`SKILL.md`](./Skills/Documentation/repo-docs-builder/SKILL.md) |
| 🗂️ **Skill-Data** | [`Resources/Skill-Data/Documentation/repo-docs-builder/`](./Resources/Skill-Data/Documentation/repo-docs-builder/README.md) |
| 📐 **Examples** | [`Examples/`](./Resources/Skill-Data/Documentation/repo-docs-builder/Examples/README.md) — worked headers, the annotated docs tree + a completed Tier-3 index, and the target web-app layout |
| 🖼️ **Screenshots** | [`Images/Screenshots/`](./Resources/Skill-Data/Documentation/repo-docs-builder/Images/Screenshots/README.md) |
| 🎞️ **GIFs** | [`Images/GIFs/`](./Resources/Skill-Data/Documentation/repo-docs-builder/Images/GIFs) |
...
| Part | Link |
|:---|:---|
| 📄 **Skill** | [`SKILL.md`](./Skills/Web/project-hub-scaffold/SKILL.md) |
| 💻 **Script** | [`scripts/scaffold-hub.ps1`](./Skills/Web/project-hub-scaffold/scripts/scaffold-hub.ps1) |
| 📚 **References** | [`design-system.md`](./Skills/Web/project-hub-scaffold/references/design-system.md) — theme tokens, layout, keyboard shortcuts · [`config-schema.md`](./Skills/Web/project-hub-scaffold/references/config-schema.md) — server/workspace configs, endpoints, watcher, testing · [`current-features.md`](./Skills/Web/project-hub-scaffold/references/current-features.md) — current reader, search, reports, pictures, bookmarks and folder views |
| 🗂️ **Skill-Data** | [`Resources/Skill-Data/Web/project-hub-scaffold/`](./Resources/Skill-Data/Web/project-hub-scaffold/README.md) |
...
| Repo | How it relates |
|:---|:---|
| [**project-hub**](https://github.com/ai-automation-tools/project-hub) | Browsable local console for a CLI-agent workspace. Ships a travel copy of [`project-hub-scaffold`](./Skills/Web/project-hub-scaffold/SKILL.md) so the skill works without this repo present — **this repo is the canonical copy**; change it here first. |
