...
[`repo-docs-builder`](../../../../Skills/Documentation/repo-docs-builder/SKILL.md) is the **end-to-end repo builder** — it scaffolds or reorganizes a whole git repo, project folder, doc library, or Obsidian vault so it's professional and navigable top to bottom. It covers four concerns in one skill:
