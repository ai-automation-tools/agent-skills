...
The end-state [`repo-docs-builder`](../../../../../Skills/Documentation/repo-docs-builder/SKILL.md) produces for a **web-app** repo: a clean root, every web/app artifact under `src/` (or `site/` for a static site), and a linked README index tree you can click through from the root to any document and back.
