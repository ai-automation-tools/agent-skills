...
Structure follows [`repo-docs-builder`](../../../../../Skills/Documentation/repo-docs-builder/SKILL.md) §2 (the index tree); the header + table styling below follows §3.2 and §4.3 of the same skill (centered emoji-title section header, leftmost-bold-column table, centered up-link footer).
