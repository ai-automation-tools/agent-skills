...
Reference exemplars for the [`repo-docs-builder`](../../../../../Skills/Documentation/repo-docs-builder/SKILL.md) skill, grouped by the concern each one illustrates. These are exemplars of the target look and structure, not runtime inputs.
