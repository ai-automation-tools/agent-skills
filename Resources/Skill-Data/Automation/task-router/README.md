...
[`task-router`](../../../../Skills/Automation/task-router/SKILL.md) decides **how much machinery a request deserves** before any work starts, then picks the model to run it on. Two decisions, in that order:
...
<p align="center">
  ...
  <a href="../../../../Skills/Automation/task-router/SKILL.md">The skill →</a>
</p>
