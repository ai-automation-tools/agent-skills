# repo-docs-builder — Examples

Reference exemplars for the [`repo-docs-builder`](../../../../../../Skills/Core/Documentation/repo-docs-builder/SKILL.md) skill, grouped by the concern each one illustrates. These are exemplars of the target look and structure, not runtime inputs.
...
<p align="center">
  <a href="../README.md">← repo-docs-builder Skill-Data home</a>
</p>
