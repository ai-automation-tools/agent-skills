...
The `Acme-Dashboard` repo implements **Tiers 1 and 2** of the index tree well, and shows exactly where **Tier 3** is missing. This is the concrete example [`repo-docs-builder`](../../../../../../Skills/Core/Documentation/repo-docs-builder/SKILL.md) §2 (the documentation tree) is modeled on.
