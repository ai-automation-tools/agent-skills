...
[`html-email-templates`](../../../../../Skills/Core/Automation/html-email-templates/SKILL.md) houses three reusable HTML email templates, so an agent building or sending an automation email picks the right shape instead of improvising one:
