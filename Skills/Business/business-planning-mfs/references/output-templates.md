...
Every file `business-planning-mfs` writes, and the house style it writes them in. The style is `repo-builder-mfs` — if that skill is installed, it's the authority and this file is the condensed travel copy. If it isn't, everything you need is here.
